...
const char* ssid = "Redmi 12 5G"; // The name of the WiFi network you want to connect to
const char* password = "8639668662"; // The password of the WiFi network
...
int Speed = 255; // A variable to store the speed value
